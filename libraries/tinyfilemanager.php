...
$default_timezone = \System\Config::get('application.timezone');
...
$root_url = \System\URL::home();

// Server hostname. Can set manually if wrong
$http_host = \System\Request::server('http_host');
...
function fm_get_translations($tr) {
    try {
        $content = false;
        if (file_exists($translation = __DIR__.'/translation.json')) {
            $content = @file_get_contents($translation);
        }
        if($content !== FALSE) {
